    ...
    private bool check_username () {
        ...
        if (username_entry_text == "") {
            ...
            if (username_is_taken) {
                username_error_revealer.label = _("Chosen username already taken");
            } else if (!username_is_valid) {
                username_error_revealer.label = _("A username can only contain lowercase letters and numbers, without spaces");
            }
